...
final class PageController extends AbstractController
{
    ...
    public function index(
        ...
        return $this->render('page/index.html.twig', [
            ...
            'maxLikes' => $maxLikes,
            // Pasamos también las palabras de tendencia mensual
    ...
    public function ranking(
        ...
        $now = $this->timeService->getNow();
        // Clonamos la fecha para no liarla modificando la original
        ...
        return $this->render('page/ranking.html.twig', [
            ...
            'period' => $period,
            'debugDate' => $now, // Pasamos la fecha simulada para el contexto visual (si nos hace falta)
            'maxLikes' => $maxLikes
        ]);
    }
    ...
    public function toggleFollow(
        ...
        if ($request->isXmlHttpRequest() || $request->headers->get('Accept') === 'application/json') {
            return $this->json([
                'following' => !$existingFollow, // Si existía, entonces lo acabamos de quitar (false). Si no, lo pusimos (true).
    ...
    public function deletePalabra(
        ...
        // Verificación del Token CSRF por seguridad antes de borrar la publicación
    ...
    public function rankingWidget(
        ...
        // Sugerir usuarios top para seguir
