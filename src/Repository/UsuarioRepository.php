...
class UsuarioRepository extends ServiceEntityRepository
{
    ...
    public function findTopUsersByFollowers(int $limit = 10, \DateTimeInterface $startDate = null): array
    {
        $qb = $this->createQueryBuilder('u')
            ...
            ->where('u.isBlocked = :blocked OR u.isBlocked IS NULL') // Nos aseguramos de que el usuario no tenga ban (contando con que sea NULL)
    ...
    //    /**
    //     * @return Usuario[] Devuelve un array de objetos Usuario
    //     */
